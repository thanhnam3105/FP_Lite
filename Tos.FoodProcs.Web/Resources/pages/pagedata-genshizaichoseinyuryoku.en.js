(function () {
    ...
    var lang = App.ui.pagedata.lang("en", {
        ...
        _pageTitle: { text: "Input Material Adjustment" },
        // 検索条件
        dt_chosei_hassei: { text: "Date" },
        // 明細
        cd_hinmei: { text: "Code" },
        nm_hinmei: { text: "Material name" },
        nm_kbn_hin: { text: "Item<br>type" },
        nm_nisugata: { text: "Packing<br>style" },
        tani_shiyo: { text: "Usage unit" },
        su_chosei: { text: "Quantities" },
        nm_riyu: { text: "Reason of<br>adjustment" },
        biko: { text: "Notes" },
        cd_seihin: { text: "Product code" },
        nm_seihin: { text: "Product name" },
        cd_update: { text: "Updater code" },
        nm_update: { text: "Updater" },
        dt_update: { text: "Update<br>date" },
        ...
        flg_mishiyo: { text: "Unused flag (product)" },
    ...
    App.ui.pagedata.validation("en", {
        ...
        su_chosei: {
            rules: {
                required: "Number of preparations",
                //      number: true,
        ...
        nm_riyu: {
            rules: {
                required: "Reason of preparation"
            },
            messages: {
                required: MS0042
            }
        ...
        dt_chosei_hassei: {
            rules: {
                required: "Preparation occur date",
                datestring: true,
