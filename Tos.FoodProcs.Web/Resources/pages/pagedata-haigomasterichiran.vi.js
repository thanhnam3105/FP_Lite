(function () {
    var lang = App.ui.pagedata.lang("vi", {
        ...
        flg_tenkai: { text: "Triển khai" },
        mishiyo: { text: "Hiển thị DL KSD", tooltip: "Hiển thị cả dữ liệu không sử dụng"},
        flg_shiyo: { text: "Có" },
        flg_mishiyo: { text: "Không có" },
        ts: { text: "Timestamp" },
