...
(function () {
    App.ui.pagedata.lang("zh", {
        ...
        // 【初期値】 日付
        dateShokichi: { text: "1975/01/01" },
        // 【初期値】 ライン登録
        lineTorokuShokichi: { text: "无" },
        // 【初期値】 合算フラグ
        ...
        // 【excel出力ヘッダ】検索未設定
        noSelectConditionExcel: { text: "未选择" },
        // 【excel出力ヘッダ】チェックボックスon
        onCheckBoxExcel: { text: "选择" },
        ...
        // 【日付フォーマット】日本
        yearStartPos: { number: 0 },
        monthStartPos: { number: 5 },
        dayStartPos: { number: 8 },
