(function () {
    ...
    var lang = App.ui.pagedata.lang("zh", {
        ...
        //_pageTitle: { text: "警告列表创建" },
        _pageTitle: { text: "警告列表" },
        // 検索条件
        dt_target: { text: "开始日" },
        dt_target_to: { text: "结束日" },
        //kbn_hin: { text: "品区分" },
        kbn_hin: { text: "商品区分" },
        //hin_bunrui: { text: "品分类" },
        hin_bunrui: { text: "商品分类" },
        kurabasho: { text: "仓库地点" },
        hinmei: { text: "品名" },
        keikoku_min: { text: "警告列表" },
        keikoku_max: { text: "最大库存也警告" },
        zenZaiko_tojitsuShiyo: { text: "前一天库存－当天使用" },
        allGenshizai: { text: "显示全部原材料" },
        considersLeadtime: { text: "采纳入库期" },
        between: { text: "　～　" },
        // 一覧
        dt_hizuke: { text: "月/日" },
        ...
        nm_torihiki: { text: "采购商名" },
        // ボタン
        hendohyo: { text: "变动表" },
        zaiko_update: { text: "计算库存更新" },
        // 隠し項目など
