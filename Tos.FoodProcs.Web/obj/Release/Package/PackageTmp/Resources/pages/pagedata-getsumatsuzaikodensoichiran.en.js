(function () {
    var lang = App.ui.pagedata.lang("en", {
        _pageTitle: { text: "Month-end Stocktaking Transmission List" },

        // ヘッダー項目
        to: { text: "～" },
        dateDensoSt: { text: "Transmission date(from)" },
        dateDensoEn: { text: "Transmission date(to)" },
        dateTanaoroshiSt: { text: "Stocktaking date(from)" },
        dateTanaoroshiEn: { text: "Stocktaking date(to)" },
    ...
    App.ui.pagedata.validation("en", {
        ...
        dt_zaiko_start: {
            rules: {
                required: "Stocktaking date(from)",
                datestring: "Stocktaking date(from)",
                greaterdate: new Date("3001/01/01"),
                lessdate: new Date("1969/12/31")
            },
            messages: {
        ...
        dt_zaiko_end: {
            rules: {
                required: "Stocktaking date(to)",
                datestring: "Stocktaking date(to)",
                greaterdate: new Date("3001/01/01"),
                lessdate: new Date("1969/12/31")
            },
            messages: {
