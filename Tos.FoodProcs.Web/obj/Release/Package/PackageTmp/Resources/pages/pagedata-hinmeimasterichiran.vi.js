(function () {
    var lang = App.ui.pagedata.lang("vi", {
        ...
        mishiyo: { text: "Hiển thị NVL KSD", tooltip: "Hiển thị nguyên vật liệu không sử dụng"},
        // ★共通の項目
        cd_hinmei: { text: "Mã" },
        nm_hinmei: { text: "Tên" },
        ...
        kbn_hin: { text: "Loại NVL" },
        nm_kbn_hin: { text: "Loại NVL" },
        // nm_nisugata_hyoji: { text: "For display of<br>packing style" },
        nm_nisugata_hyoji: { text: "Quy cách đóng gói" },
        wt_nisugata_naiyo: { text: "Lượng trong QCĐG", tooltip: "Trọng lượng trong quy cách đóng gói"},
        su_iri: { text: "SL bên trong", tooltip: "Số lượng bên trong" },
        wt_ko: { text: "TL 1 cái", tooltip: "Trọng lượng 1 cái"},
        kbn_kanzan: { text: "ĐV TL 1 cái", tooltip: "Đơn vị trọng lượng 1 cái"},
        nm_kbn_kanzan: { text: "Đơn vị trọng lượng 1 cái" },
        ...
        dd_kaifugo_shomi: { text: "HSD sau khi mở", tooltip: "Hạn sử dụng sau khi mở"},
        ...
        dd_kaitogo_shomi: { text: "HSD sau khi<br>rã đông", tooltip: "Hạn sử dụng sau khi rã đông" },
        kikan_kaitogo_shomi_tani: { text: "HSD sau khi<br>rã đông(ngày)" },
        ...
        dd_leadtime: { text: "TG cung ứng", tooltip: "Thời gian cung ứng" },
        biko: { text: "Ghi chú" },
        ...
        cd_jan: { text: "Mã JAN" },
        su_batch_dekidaka: { text: "SL của 1 mẻ SX", tooltip: "Sản lượng của 1 mẻ sản xuất" },
        su_palette: { text: "Thừa số pallet" },
        kin_romu: { text: "Chi phí LĐTC", tooltip: "Chi phí lao động tiêu chuẩn" },
        ...
        line: { text: "Đăng ký DCSX", tooltip: "Đăng ký dây chuyền sản xuất" },
        ...
        su_hachu_lot_size: { text: "Size lô đặt hàng" },
        ...
        errorHinKbnParamShiza: { text: "Lỗi đăng ký sử dụng nguyên vật liệu: " },
