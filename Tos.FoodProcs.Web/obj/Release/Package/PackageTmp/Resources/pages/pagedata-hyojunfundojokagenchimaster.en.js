(function () {
    ...
    var lang = App.ui.pagedata.lang("en", {
        // 画面項目
        _pageTitle: { text: "Weight Limit Value Master"},
        cd_fundo: { text: "Code" },
        wt_fundo: { text: "Standard weight (g)" },
        wt_fundo_jogen: { text: "Minimum (g)" },
        wt_fundo_kagen: { text: "Maximum (g)" },
    ...
    App.ui.pagedata.validation("en", {
        ...
        wt_fundo: {
            ...
            params: {
                custom: ["Minimum", "Standard weight"]
            },
            messages: {
                //required: MS0042,
                number: MS0441,
