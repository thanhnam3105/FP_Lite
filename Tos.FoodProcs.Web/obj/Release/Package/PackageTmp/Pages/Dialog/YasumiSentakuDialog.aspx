<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YasumiSentakuDialog.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.Dialog.YasumiSentakuDialog" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $.dlg.register("YasumiSentakuDialog", {
            // TODO：ここまで
            initialize: function (context) {
                ...
                var selectShokubaName = context.data.param1,
                    selectLineName = context.data.param2;
                ...
                var dialog_grid = elem.find(".dialog-result-list [name='dialog-list']"),
				    querySettingDialog = { skip: 0, top: 499, count: 0 },
                ...
                var createFilterDialog = function () {
                    ...
                    filters.push("kbn_bunrui_riyu eq " + pageLangText.kyujitsuRiyuKbn.text);
                    if (!App.isUndefOrNull(criteria.cd_riyu_dlg)) {
                        filters.push("substringof('" + encodeURIComponent(criteria.cd_riyu_dlg) + "', cd_riyu) "
                            + "or substringof('" + encodeURIComponent(criteria.cd_riyu_dlg) + "', nm_riyu)");
                    }
                    // TODO：ここまで
                ...
                var bindDataDialog = function (result) {
                    ...
                    // 休日解除用の値をセット
                    var setNo = querySettingDialog.skip;
                    //if (setNo > 0) {
                        result.d.results[setNo] = { "cd_riyu": pageLangText.kyujitsuKaijyo.text, "nm_riyu": pageLangText.txt_kyujitsu_kaijyo.text };
                        result.d.__count = setNo + 1;
                        querySettingDialog.skip = result.d.__count;
                        resultCount = result.d.__count;
                    //}
                ...
                dialog_grid.jqGrid({
                    ...
                    colNames: [
                        pageLangText.cd_riyu_dlg.text,
                        pageLangText.nm_riyu_dlg.text
                    ],
                    // todo：ここまで
                    // todo：画面の仕様に応じて以下の列モデルの定義を変更してください。
                    colModel: [
                        { name: 'cd_riyu', width: 115, align: "left" },
                        { name: 'nm_riyu', width: 240, align: "left" }
                    ],
                    // todo：ここまで
                    datatype: "local",
                    shrinkToFit: false,
                ...
                var returnSelectedDialog = function () {
                    ...
                    for (var i = 0; i < selArray.length; i++) {
                        ...
                        selCode.push(row.cd_riyu);
                        selName.push(row.nm_riyu);
                    }
                    // TODO：ここまで
                ...
                this.reopen = function (option) {
                    ...
                    clearStateDialog();
                    // 条件をセット
                    selectShokubaName = option.param1,
                    selectLineName = option.param2;
                    searchItemsDialog(new queryDialog());
                };
...
<body>
    ...
    <div class="dialog-content">
        ...
        <div class="dialog-header">
            <h4 data-app-text="yasumiItiranDialog">
            </h4>
        </div>
        <div class="dialog-body" style="padding: 10px; width: 95%;">
            <div class="dialog-search-criteria">
				<div class="part-body">
                    ...
                    <ul class="item-list">
                        <li>
                            <label>
                                <span class="item-label" data-app-text="cd_riyu_dlg" style="width: 80px;"></span>
                                <input type="text" id="con_cd_riyu_dlg" name="cd_riyu_dlg" style="width: 200px;" maxlength="50" />
                            </label>
                        </li>
                    </ul>
				</div>
            ...
            <div class="dialog-result-list">
                ...
                <div class="part-body" style="height: 165px;">
