<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SetsubiMaster.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.SetsubiMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-setsubimaster." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
        ...
        $(App.ui.page).on("ready", function () {
            ...
            */
            ...
            grid.jqGrid({
                ...
                colNames: [
                    pageLangText.shokuba.text, pageLangText.cd_setsubi.text + pageLangText.requiredMark.text, pageLangText.nm_setsubi.text + pageLangText.requiredMark.text,
                    pageLangText.flg_mishiyo.text, pageLangText.cd_create.text, pageLangText.dt_create.text, pageLangText.ts.text
                ],
                // TODO：ここまで
                ...
                colModel: [
                    ...
                    { name: 'cd_setsubi', width: 120, editable: true, sorttype: "text", hidden: false, align: 'left' },
                    { name: 'nm_setsubi', width: 450, editable: true, sorttype: "text", align: 'left' },
                    { name: 'flg_mishiyo', width: 60, editable: true, hidden: false, edittype: 'checkbox',
                ...
                loadComplete: function () {
                    ...
                    for (var i = 0; i < ids.length; i++) {
                        ...
                        if (grid.jqGrid('getCell', id, 'ts')) {
                            grid.jqGrid('setCell', id, 'cd_setsubi', '', 'not-editable-cell');
                        }
                        // TODO：ここまで
                    }
                },
            ...
            $(document).on("click", "#item-grid .jqgrow td :checkbox", function () {
                ...
                var iCol = $(this).parent("td").parent("tr").find("td").index($(this).parent("td")),
                    ...
                    cellName = grid.getGridParam("colNames")[iCol],
                    value;
            ...
            App.deferred.parallel({
                ...
                shokuba: App.ajax.webget("../Services/FoodProcsService.svc/ma_shokuba?$filter=flg_mishiyo eq 0&$orderby=cd_shokuba")
                // TODO: ここまで
            ...
            var query = function () {
                var query = {
                    // TODO: 画面の仕様に応じて以下のサービスのエンドポイントを変更してください。
                    url: "../Services/FoodProcsService.svc/ma_setsubi",
                    // TODO: ここまで
                    filter: createFilter(),
            ...
            var setCreatedChangeData = function (newRow) {
                ...
                var changeData = {
                    ...
                    "cd_setsubi": newRow.cd_setsubi,
                    "nm_setsubi": newRow.nm_setsubi,
            ...
            var setUpdatedChangeData = function (row) {
                ...
                var changeData = {
                    ...
                    "cd_setsubi": row.cd_setsubi,
                    "nm_setsubi": row.nm_setsubi,
                    "flg_mishiyo": row.flg_mishiyo,
                  //  "dt_create": new Date(row.dt_create),
                    ...
                    for (var i = 0; i < ret.length; i++) {
                        ...
                        if (ret[i].InvalidationName === "NotExsists") {
                            ...
                            for (var j = 0; j < ids.length; j++) {
                                ...
                                retValue = ret[i].Data.cd_setsubi;
                                // TODO: ここまで
                                ...
                                if (value === retValue) {
                                    ...
                                    // 対象セルの背景変更
                                    grid.setCell(ids[j], firstCol, ret[i].Data.cd_setsubi, { background: '#ff6666' });
                                    // TODO: ここまで
                                }
                            }
                        }
                ...
                if (!App.isUndefOrNull(ret.Updated) && ret.Updated.length > 0) {
                    for (var i = 0; i < ret.Updated.length; i++) {
                        for (p in changeSet.changeSet.updated) {
                            ...
                            retValue = ret.Updated[i].Requested.cd_setsubi;
                            // TODO: ここまで
                           ...
                           // if (isNaN(value) || value === retValue) {
                                ...
                                if (App.isUndefOrNull(ret.Updated[i].Current)) {
                                    ...
                                    current.cd_shokuba = ret.Updated[i].Current.cd_shokuba;
                                    current.cd_setsubi = ret.Updated[i].Current.cd_setsubi;
                                    current.nm_setsubi = ret.Updated[i].Current.nm_setsubi;
            ...
            // <summary>CSVアップロードダイアログの「いいえ」ボタンクリック時のイベント処理を行います。</summary>
