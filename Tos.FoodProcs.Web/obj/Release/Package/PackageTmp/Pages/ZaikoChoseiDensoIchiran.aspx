<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ZaikoChoseiDensoIchiran.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.ZaikoChoseiDensoIchiran" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-zaikochoseidensoichiran." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
    ...
    <script type="text/javascript">
        ...
        $(App.ui.page).on("ready", function () {
            ...
            */
            ...
            dateformat('dt_tenki_start');
            dateformat('dt_tenki_end');
            ...
            grid.jqGrid({
                colNames: [
                    ...
                    pageLangText.dt_tenki.text,
                    pageLangText.cd_soko.text,
                    pageLangText.nm_soko.text,
                    pageLangText.cd_genka_center.text,
                    pageLangText.nm_genka_center.text,
                    pageLangText.cd_riyu.text,
                    pageLangText.nm_riyu.text,
                    ...
                    pageLangText.dt_denpyo.text,
                    pageLangText.kbn_ido.text,
                ],
                colModel: [
                    ...
                    { name: 'dt_tenki', width: pageLangText.dt_tenki_width.number, sorttype: "date",
                        formatter: "date",
                        formatoptions: {
                            srcformat: newDateFormat, newformat: newDateFormat
                        }
                    },
                    { name: 'cd_soko', width: pageLangText.cd_soko_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'nm_soko', width: pageLangText.nm_soko_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'cd_genka_center', width: pageLangText.cd_genka_center_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'nm_genka_center', width: pageLangText.nm_genka_center_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'cd_riyu', width: pageLangText.cd_riyu_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'nm_riyu', width: pageLangText.nm_riyu_width.number, editable: true, align: 'left', sorttype: "text" },
                    ...
                    { name: 'su_chosei', width: pageLangText.su_chosei_width.number, sorttype: "int", align: "right",
                        formatter: 'integer',
                        formatoptions: {
                            thousandsSeparator: ",", decimalPlaces: 2, defaultValue: "0"
                        }
                    },
                    ...
                    { name: 'dt_denpyo', width: pageLangText.dt_denpyo_width.number, sorttype: "date",
                        formatter: "date",
                        formatoptions: {
                            srcformat: newDateFormat, newformat: newDateFormat
                        }
                    },
                    { name: 'kbn_ido', width: pageLangText.kbn_ido_width.number, editable: true, align: 'left', sorttype: "text" }
                ],
                datatype: "local",
                shrinkToFit: false,
                multiselect: false,
            ...
            var query = function () {
                ...
                var flgDenso = pageLangText.falseFlg.text,
                    flgTenki = pageLangText.falseFlg.text;
                ...
                if (criteria.chk_tenki == "on") {
                    flgTenki = pageLangText.trueFlg.text;
                }

                var query = {
                    url: "../api/ZaikoChoseiDensoIchiran",
                    ...
                    dt_tenki_from: App.data.getDateTimeStringForQueryNoUtc(criteria.dt_tenki_start),
                    dt_tenki_to: App.data.getDateTimeStringForQueryNoUtc(criteria.dt_tenki_end),
            ...
            var checkDateSearch = function () {
                ...
                // 項目が1つは入力されているかチェック
                if ((App.isUndefOrNull(criteria.chk_denso)) && (App.isUndefOrNull(criteria.chk_tenki))
                ...
                //検索条件/転記日チェック
                if (criteria.chk_tenki != null) {
                    var DateFrom = new Date($(".search-criteria [name='dt_tenki_start']").datepicker("getDate"));
                    var DateTo = new Date($(".search-criteria [name='dt_tenki_end']").datepicker("getDate"));
                    if (DateFrom > DateTo) {
                        App.ui.page.notifyAlert.message(App.str.format(pageLangText.inputDateError.text, pageLangText.dateTenkiEn.text, pageLangText.dateTenkiSt.text), $("#dt_tenki_start")).show();
                        return false;
                    }
                    chk_dt_tenki = pageLangText.chk_search_on.text;
                }
                else {
                    chk_dt_tenki = pageLangText.chk_search_non.text;
                }
                return true;
            };
            ...
            <ul class="item-list">
                ...
                <li>
                    <table width="90%">
                        ...
                        <tr>
                            <td width="5%"  height="20" style="padding-bottom: 5px;">
                                <input type="checkbox" name="chk_tenki" id="chk_tenki" checked="checked"/>
                                <span class="item-label" data-app-text="dateTenkiSt"></span>
                                <input type="text" name="dt_tenki_start" id="dt_tenki_start" />
                                <span class="item-label" data-app-text="to" style="text-align:center; width:30px;"></span>
                                <span class="item-label" data-app-text="dateTenkiEn"></span>
                                <input type="text" name="dt_tenki_end" id="dt_tenki_end" />
                            </td>
                        </tr>
                    </table>
                </li>
