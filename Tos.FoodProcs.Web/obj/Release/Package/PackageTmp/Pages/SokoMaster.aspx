<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SokoMaster.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.SokoMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-sokomaster." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
        ...
        $(App.ui.page).on("ready", function () {
            ...
            */
            ...
            grid.jqGrid({
                ...
                colNames: [
                    pageLangText.sokoCode.text + pageLangText.requiredMark.text
                    , pageLangText.sokoName.text + pageLangText.requiredMark.text
                ...
                colModel: [
                    { name: 'cd_soko', width: 80, editable: true, hidden: false },
                    { name: 'nm_soko', width: 400, editable: true, sorttype: "text" },
            ...
            var query = function () {
                var query = {
                    url: "../Services/FoodProcsService.svc/ma_soko",
                    //filter: createFilter(),
                    orderby: "cd_soko",
                    ...
                    for (var i = 0; i < ret.length; i++) {
                        ...
                        if (ret[i].InvalidationName == "NotExsists") {
                            ...
                            for (var j = 0; j < ids.length; j++) {
                                ...
                                if (value === retValue) {
                                    ...
                                    // 対象セルの背景変更
                                    grid.setCell(ids[j], firstCol, ret[i].Data.cd_soko, { background: '#ff6666' });
                                    // TODO: ここまで
                                }
                            }
                        }
                        if (ret[i].InvalidationName == "DuplicateKey") {
                            ...
                            for (p in changeSet.changeSet.deleted) {
                                ...
                                // TODO: 画面の仕様に応じて以下の値を変更します。
                                value = changeSet.changeSet.deleted[p].cd_soko;
                                retValue = ret[i].Data.cd_soko;
                                // TODO: ここまで
                ...
                if (!App.isUndefOrNull(ret.Updated) && ret.Updated.length > 0) {
                    for (var i = 0; i < ret.Updated.length; i++) {
                        for (p in changeSet.changeSet.updated) {
                            ...
                            retValue = ret.Updated[i].Requested.cd_soko;
                            // TODO: ここまで
                ...
                if (!App.isUndefOrNull(ret.Deleted) && ret.Deleted.length > 0) {
                    for (var i = 0; i < ret.Deleted.length; i++) {
                        for (p in changeSet.changeSet.deleted) {
                            ...
                            // TODO: 画面の仕様に応じて以下の値を変更します。
                            value = changeSet.changeSet.deleted[p].cd_soko;
                            retValue = ret.Deleted[i].Requested.cd_soko;
                            // TODO: ここまで
