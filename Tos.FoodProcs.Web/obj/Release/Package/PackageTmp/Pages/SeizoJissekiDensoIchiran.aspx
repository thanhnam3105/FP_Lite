<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SeizoJissekiDensoIchiran.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.SeizoJissekiDensoIchiran" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-seizojissekidensoichiran." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
    ...
    <script type="text/javascript">
        ...
        $(App.ui.page).on("ready", function () {
            ...
            */
            ...
            dateformat('dt_seizo_start');
            dateformat('dt_seizo_end');
            ...
            grid.jqGrid({
                colNames: [
                    ...
                    pageLangText.su_seizo_jisseki.text,
                ...
                colModel: [
                    ...
                    { name: 'no_lot_seihin', width: pageLangText.no_lot_seihin_width.number, editable: true, align: 'left', sorttype: "text" },
                    { name: 'su_seizo', width: pageLangText.su_seizo_jisseki_width.number, sorttype: "int", align: "right",
                        formatter: 'integer',
                        formatoptions: {
                    ...
                    { name: 'no_lot_hyoji', width: 250, editable: true, align: 'left', sorttype: "text" }
                ],
                datatype: "local",
                shrinkToFit: false,
                multiselect: false,
            ...
            var query = function () {
                ...
                var flgDenso = pageLangText.falseFlg.text,
                    flgSeizo = pageLangText.falseFlg.text;
                ...
                if (criteria.chk_seizo == "on") {
                    flgSeizo = pageLangText.trueFlg.text;
                }

                var query = {
                    url: "../api/SeizoDensoIchiran",
                    ...
                    dt_seizo_from: App.data.getDateTimeStringForQueryNoUtc(criteria.dt_seizo_start),
                    dt_seizo_to: App.data.getDateTimeStringForQueryNoUtc(criteria.dt_seizo_end),
                    cd_hinmei: encodeURIComponent(criteria.cd_seihin),
                    no_lot_seihin: encodeURIComponent(criteria.seihinLot),
                    chk_denso: flgDenso,
                    chk_seizo: flgSeizo,
                    //lot_put_char: putChar,
            ...
            var checkDateSearch = function () {
                ...
                if ((App.isUndefOrNull(criteria.chk_denso)) && (App.isUndefOrNull(criteria.chk_seizo))
                  && (App.isUndefOrNull(criteria.cd_seihin)) && (App.isUndefOrNull(criteria.seihinLot))
                ) {
                    App.ui.page.notifyAlert.message(
                        App.str.format(pageLangText.inputCheck.text, pageLangText.requiredInput.text), $("#chk_denso")
                    ).show();
                    return false;
                }
                ...
                //検索条件/製造日チェック
                if (criteria.chk_seizo != null) {
                    var DateFrom = new Date($(".search-criteria [name='dt_seizo_start']").datepicker("getDate"));
                    var DateTo = new Date($(".search-criteria [name='dt_seizo_end']").datepicker("getDate"));
                    if (DateFrom > DateTo) {
                        App.ui.page.notifyAlert.message(
                            App.str.format(pageLangText.inputDateError.text, pageLangText.dateSeizoEn.text, pageLangText.dateSeizoSt.text)
                            , $("#dt_seizo_start")
                        ).show();
                        return false;
                    }
                    chk_dt_seizo = pageLangText.chk_search_on.text;
                }
                else {
                    chk_dt_seizo = pageLangText.chk_search_non.text;
                }
                return true;
            };
            ...
            var isValidHinmeiCode = function (hinmeiCode) {
                ...
                var queryHin = {
                    ...
                    filter: "cd_hinmei eq '" + criteria.cd_seihin + "' and kbn_hin eq " + pageLangText.seihinHinKbn.text,
                    orderby: "cd_hinmei",
                ...
                App.ajax.webgetSync(
                    ...
                    if (result.d.__count == 0) {
                        ...
                        if (App.isUndefOrNull(result.d.results[0][hinmeiName])) {
                            ...
                            $("#nm_seihin_search").text(result.d.results[0][hinmeiName]);
                        }
                        isValid = true;
                    }
                }).fail(function (result) {
            ...
            */
            ...
            var showHinmeiDialog = function () {
                ...
                var option = { id: 'genryo', multiselect: false, param1: pageLangText.seihinHinDlgParam.text };
            ...
            <ul class="item-list">
                ...
                <li>
                    <table width="90%">
                        ...
                        <tr>
                            <td width="5%"  height="20" style="padding-bottom: 5px;">
                                <input type="checkbox" name="chk_seizo" id="chk_seizo" checked="checked"/>
                                <span class="item-label" data-app-text="dateSeizoSt"></span>
                                <input type="text" name="dt_seizo_start" id="dt_seizo_start" />
                                <span class="item-label" data-app-text="to" style="text-align:center; width:30px;"></span>
                                <span class="item-label" data-app-text="dateSeizoEn"></span>
                                <input type="text" name="dt_seizo_end" id="dt_seizo_end" />
                            </td>
                        </tr>
                    </table>
                </li>
                <li>
                    ...
                    <button type="button" class="dialog-button" id="seihin-category-button">
                        ...
                        <span class="item-label"  name="nm_seihin_search" id="nm_seihin_search" readonly="readonly" style="margin-left:23px;"></span>
                    </label>
                </li>
                <li>
                    <label>
                        <span class="item-label" data-app-text="SeihinLot" style="padding-left:26px;"></span>
                        <input type="text" class="changeCheck" name="seihinLot" id="seihinLot"  maxlength="14"/>
                    </label>
                </li>
                <!-- TODO: ここまで -->
            </ul>
