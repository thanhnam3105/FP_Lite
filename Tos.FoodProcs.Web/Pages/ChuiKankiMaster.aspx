<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ChuiKankiMaster.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.ChuiKankiMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-chuikankimaster." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
            ...
            */
            ...
            grid.jqGrid({
                colNames: [
                    ...
                    , pageLangText.nm_chui_kanki.text + pageLangText.requiredMark.text
                ...
                colModel: [
                    ...
                    { name: 'nm_chui_kanki', width: pageLangText.nm_chui_kanki_width.number, editable: true, align: "left", sorttype: "text" },
            ...
            App.deferred.parallel({
                ...
                kankiKbn: App.ajax.webget("../Services/FoodProcsService.svc/ma_kbn_chui_kanki?&$orderby=kbn_chui_kanki")
            }).done(function (result) {
                kankiKbn = result.successes.kankiKbn.d;
                // 検索用ドロップダウンの設定
                App.ui.appendOptions($(".search-criteria [name='kankiKbn']"), "kbn_chui_kanki", "nm_kbn_chui_kanki", kankiKbn, false);
            ...
            var createFilter = function () {
                ...
                filters.push("kbn_chui_kanki eq " + criteria.kankiKbn + "");
            ...
            var setAddData = function () {
                var addData = {
                    "kbn_chui_kanki": searchCondition.kankiKbn,
                    "cd_chui_kanki": "",
                    "nm_chui_kanki": "",
                    "flg_mishiyo": "",
                    "dt_create": "",
            ...
            var setCreatedChangeData = function (newRow) {
                var changeData = {
                    ...
                    "nm_chui_kanki": newRow.nm_chui_kanki,
            ...
            var setUpdatedChangeData = function (row) {
                var changeData = {
                    ...
                    "nm_chui_kanki": row.nm_chui_kanki,
            ...
            var addData = function (e) {
                ...
                // 検索条件が変更されていないこと
                if (criteria.kankiKbn != searchCondition.kankiKbn) {
                    App.ui.page.notifyAlert.clear();
                    ...
                    for (var i = 0; i < ret.length; i++) {
                        ...
                        if (ret[i].InvalidationName == "DuplicateKey") {
                            ...
                            for (var j = 0; j < ids.length; j++) {
                                ...
                                retValue = ret[i].Data.cd_chui_kanki;
                            ...
                            for (p in changeSet.changeSet.deleted) {
                                ...
                                // TODO: 画面の仕様に応じて以下の値を変更します。
                                value = changeSet.changeSet.deleted[p].cd_chui_kanki;
                                retValue = ret[i].Data.cd_chui_kanki;
                                // TODO: ここまで
                    ...
                    for (var i = 0; i < ret.Updated.length; i++) {
                        for (p in changeSet.changeSet.updated) {
                            ...
                            if (App.isUndefOrNull(upCurrent)) {
                                ...
                                current.cd_chui_kanki = upCurrent.cd_chui_kanki;
                                current.nm_chui_kanki = upCurrent.nm_chui_kanki;
            ...
            var saveData = function (e) {
                ...
                var saveUrl = "../api/ChuiKankiMaster";
                App.ajax.webpost(
                    saveUrl, getPostData()
                ).done(function (result) {
                    // 検索前の状態に初期化
            ...
            var clearErrBgcorror = function (errIds) {
                for (var i = 0; i < errIds.length; i++) {
                    var id = errIds[i];
                    // 対象セルの背景リセット
                    grid.setCell(id, cdChuiCol, '', { background: 'none' });
                    grid.setCell(id, nmChuiCol, '', { background: 'none' });
                }
            };
            ...
            <ul class="item-list">
                ...
                <li>
                    <label>
                        ...
                        <select name="kankiKbn" id="condition-kankiKbn">
                        </select>
                    </label>
                </li>
                <!-- TODO: ここまで -->
