<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenryoLotTorikeshiDialog.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.Dialog.GenryoLotTorikeshiDialog" %>
...
<head id="Head1" runat="server">
    <title></title>
    <style type="text/css">
        .genryo-lot-torikeshi-dlg
        {
            background-color: White;
            width: 540px;
        }
        .genryo-lot-torikeshi-dlg .item-label {
            width: 130px;
            line-height: 180%;
        }
        .genryo-lot-torikeshi-dlg .dialog-search-criteria {
            border: solid 1px #efefef;
            padding-top: 0.5em;
            padding-left: 0.5em;
        }
        .genryo-lot-torikeshi-dlg .dialog-search-criteria .part-footer {
            margin-top: 1em;
            margin-left: .5em;
            margin-right: .5em;
            position: relative;
        ...
        .genryo-lot-torikeshi-dlg .dialog-search-criteria .part-footer .command {
          /*position: absolute;*/
          display: inline-block;
          right: 0;
        }
        .genryo-lot-torikeshi-dlg .dialog-result-list {
            margin-top: 10px;
        }
        .genryo-lot-torikeshi-dlg .dialog-search-criteria .part-footer .command button {
          position: relative;
          margin-left: .5em;
          top: 5px;
          padding: 0px;
        ...
        .genryo-lot-torikeshi-dlg .ui-jqgrid-btable .ui-state-highlight,
    ...
    <script type="text/javascript">
        $.dlg.register("GenryoLotTorikeshiDialog", {
            initialize: function (context) {
                ...
                dialog_grid.jqGrid({
                    colNames: [
						pageLangText.genryo_dlg_delete.text,
						pageLangText.genryo_dlg_recei_date.text,
						pageLangText.genryo_dlg_time.text,
						pageLangText.genryo_dlg_expiry_date.text,
						pageLangText.genryo_dlg_lot_no.text
					],
                    colModel: [
						{ name: 'isDelete', resizable: false, width: pageLangText.genryo_dlg_delete.number, align: 'center', edittype: 'checkbox', editable: true, sortable: false,
						    formatter: 'checkbox',
						    editoptions: {
						        value: "True:False"
						    },
						...
						{ name: 'dt_niuke', width: pageLangText.genryo_dlg_recei_date.number, resizable: false, align: "left",
						    formatter: "date",
						    formatoptions: {
						        srcformat: dateSrcTable, newformat: dateNewTable
						    }
						},
						{ name: 'dt_nonyu', width: pageLangText.genryo_dlg_time.number, resizable: false, align: "left",
						    formatter: "date",
						    formatoptions: {
						        srcformat: dateSrcTable, newformat: dateNewTable
						    }
						},
						{ name: 'dt_kigen', width: pageLangText.genryo_dlg_expiry_date.number, resizable: false, align: "left",
						    formatter: "date",
						    formatoptions: {
						        srcformat: dateSrcTable, newformat: dateNewTable
						    }
						},
						{ name: 'no_lot', width: pageLangText.genryo_dlg_lot_no.number, align: "left" }
					],
                    datatype: "local",
                    shrinkToFit: false,
                    multiselect: false,
                    rownumbers: false,
                    hoverrows: false,
                    height: pageLangText.genryo_dlg_height_table.number,
                    multiboxonly: true,
                    loadonce: true,
                ...
                var queryDialogWeb = function () {
                    var query = {
                        url: "../api/GenryoLotTorikeshiDialog",
                ...
                var initDialog = function () {
                    ...
                    elem.find("input[name='no_lot']").val("");
                    elem.find(".list-count-dialog").text("");
...
<body>
    <div class="dialog-content">
        <div class="dialog-header">
            <h4 data-app-text="genryoLotTorikeshiDialog">
            </h4>
        </div>
        <div class="dialog-body" style="padding: 10px;">
            <div class="dialog-search-criteria" style="padding-bottom: 10px;">
                <label>
                    <span class="item-label" style="padding-right:10px;" data-app-text="genryo_item_nm_code"></span>
                </label>
        ...
        <div class="dialog-footer">
            <div class="command" style="position: absolute; left: 10px; top: 5px;">
                <button class="dlg-select-button" name="select" data-app-text="deleting">
                </button>
            </div>
