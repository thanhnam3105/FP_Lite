<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FutaiKetteiTorokuIchiranDialog.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.Dialog.FutaiDialog" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $.dlg.register("FutaiKetteiTorokuIchiranDialog", {
            // TODO：ここまで
            initialize: function (context) {
                ...
                dialog_grid.jqGrid({
                    ...
                    colNames: [
                        ...
                        , pageLangText.nm_nisugata_dlg.text
                        , pageLangText.kbn_hin_dlg.text
                    ],
                    // todo：ここまで
                    ...
                    colModel: [
                        ...
                        { name: 'nm_kbn_hin', width: 100, align: "left" },
                        { name: hinmeiName, width: 300, align: "left" },
                        { name: 'nm_nisugata', width: 100, align: "left" },
                ...
                var queryDialog = function () {
                    var query = {
                        ...
                        url: "../Services/FoodProcsService.svc/vw_ma_futai_kettei_02",
                ...
                var createFilterDialog = function () {
                    ...
                    filters.push("kbn_jotai eq " + pageLangText.sonotaJotaiKbn.text);
                    ...
                    if (!App.isUndefOrNull(criteria.nm_hinmei_dlg)) {
                        filters.push("(substringof('" + encodeURIComponent(criteria.nm_hinmei_dlg) + "', cd_hinmei) "
                            + "or substringof('" + encodeURIComponent(criteria.nm_hinmei_dlg) + "', " + hinmeiName + "))");
                    }
                    // TODO：ここまで
                ...
                var returnSelectedDialog = function () {
                    ...
                    for (var i = 0; i < selArray.length; i++) {
                        ...
                        selKubun.push(row.kbn_hin);
                        selCode.push(row.cd_hinmei);
                        selName.push(row[hinmeiName]);
                    }
                    // TODO：ここまで

                    return [selCode.join(", "), selName.join(", "), selKubun.join(", ")];
                };
...
<body>
    ...
    <div class="dialog-content">
        ...
        <div class="dialog-header">
            <h4 data-app-text="futaiKetteiDialog">
            </h4>
        </div>
                ...
                <div class="dialog-search-criteria">
                    <div class="part-body" >
                        <ul class="item-list">
                            <li>
                                <label>
                                    <span class="item-label" data-app-text="nm_hinmei_dlg" style="width: 80px;"></span>
                                    <input type="text" id="con_nm_hinmei_dlg" name="nm_hinmei_dlg" style="width: 300px;" maxlength="50" />
                                </label>
                            </li>
                        </ul>
                    </div>
