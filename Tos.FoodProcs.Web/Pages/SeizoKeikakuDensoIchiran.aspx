<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SeizoKeikakuDensoIchiran.aspx.cs" Inherits="Tos.FoodProcs.Web.Pages.SeizoKeikakuDensoIchiran" %>

<asp:Content ID="Content1" ContentPlaceHolderID="IncludeContent" runat="server">
    <script src="<%=ResolveUrl("~/Resources/pages/pagedata-seizokeikakudensoichiran." + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName + ".js") %>"
            ...
            */
            ...
            grid.jqGrid({
                colNames: [
                    ...
                    pageLangText.su_seizo_keikaku.text,
                ...
                colModel: [
                    ...
                    { name: 'su_seizo', width: pageLangText.su_seizo_keikaku_width.number, sorttype: "int", align: "right",
                        formatter: 'integer',
                        formatoptions: {
            ...
            var checkDateSearch = function () {
                ...
                if (criteria.chk_seizo != null) {
                    ...
                    if (DateFrom > DateTo) {
                        App.ui.page.notifyAlert.message(App.str.format(pageLangText.inputDateError.text, pageLangText.dateSeizoEn.text, pageLangText.dateSeizoSt.text), $("#dt_seizo_start")).show();
                        return false;
                    }
