...
GO
CREATE TABLE [dbo].[tr_sap_jisseki_seihin_denso_pool](
	...
	[su_seizo_jisseki] [decimal](13, 3) NULL,
	[cd_tani_SAP] [varchar](10) NULL,
	[dt_denso] [datetime] NOT NULL,
	[no_lot_hyoji] [varchar](30) NULL,
 CONSTRAINT [PK_tr_sap_jisseki_seihin_denso_pool] PRIMARY KEY CLUSTERED 
(
	[kbn_denso_SAP] ASC,
	[no_lot_seihin] ASC,
	[dt_denso] ASC
